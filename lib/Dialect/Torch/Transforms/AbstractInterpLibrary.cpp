...
"    return %4 : !torch.list<int>\n"
"  }\n"
"  func.func @\"__torch_mlir_shape_fn.aten.linalg_solve_ex\"(%arg0: !torch.list<int>, %arg1: !torch.list<int>, %arg2: !torch.bool, %arg3: !torch.bool) -> !torch.tuple<list<int>, list<int>> {\n"
"    %none = torch.constant.none\n"
"    %str = torch.constant.str \"AssertionError: A must be square\"\n"
"    %int-2 = torch.constant.int -2\n"
"    %int-1 = torch.constant.int -1\n"
"    %int1 = torch.constant.int 1\n"
"    %0 = torch.aten.__getitem__.t %arg0, %int-1 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %1 = torch.aten.__getitem__.t %arg0, %int-2 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %2 = torch.aten.eq.int %0, %1 : !torch.int, !torch.int -> !torch.bool\n"
"    torch.prim.If %2 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %3 = torch.aten.slice.t %arg0, %none, %int-2, %int1 : !torch.list<int>, !torch.none, !torch.int, !torch.int -> !torch.list<int>\n"
"    %4 = torch.aten.__getitem__.t %arg0, %int-1 : !torch.list<int>, !torch.int -> !torch.int\n"
"    %5 = torch.aten.__getitem__.t %arg1, %int-1 : !torch.list<int>, !torch.int -> !torch.int\n"
...
"    %9 = torch.prim.TupleConstruct %7, %8 : !torch.list<int>, !torch.list<int> -> !torch.tuple<list<int>, list<int>>\n"
"    return %9 : !torch.tuple<list<int>, list<int>>\n"
"  }\n"
